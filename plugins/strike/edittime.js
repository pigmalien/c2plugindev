...
{
	return {
		"name":			"Lightning Strike",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"LightningStrike",				// this is used to identify this plugin and is saved to the project; never change it
...
// example
AddNumberParam("Angle", "The angle to strike towards in degrees.");
AddNumberParam("Distance", "The distance of the strike in pixels.");
AddAction(0, af_none, "Strike towards", "Lightning", "Strike towards {0} degrees for {1} pixels", "Generate a lightning strike from the object position.", "StrikeTowards");
...
var property_list = [
	new cr.Property(ept_float, 	"Displacement",		100,		"Maximum displacement for jaggedness."),
...
IDEInstance.prototype.Draw = function(renderer)
{
	...
	renderer.Fill(quad, cr.RGB(255, 255, 0));
