...
AddAction(3, af_none, "Set wall tile", "Setup", "Set wall tile ID to <b>{0}</b>", "Sets the tile ID used for walls.", "SetWallTile");
...
var property_list = [
	...
	new cr.Property(ept_integer, 	"Wall Tile ID",			1,		"The tile ID to use for walls."),
    new cr.Property(ept_integer, 	"Floor Tile ID",		0,		"The tile ID to use for floors and corridors.")
];
