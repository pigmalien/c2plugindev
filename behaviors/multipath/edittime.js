...
////////////////////////////////////////
// Actions
AddStringParam("Path Name", "The unique name of the path list to add the point to (e.g., 'PatrolA', 'Loop2').", "\"Default\"");
...
AddStringParam("Path Name", "The name of the path whose index should be advanced.", "\"Default\"");
...
AddStringParam("Path Name", "The name of the path whose index should be reset.", "\"Default\"");
...
AddStringParam("Path Name", "The name of the path whose index should be backtracked.", "\"Default\"");
...
AddStringParam("Path Name", "The name of the path to clear.", "\"Default\"");
AddAction(4, af_none, "Clear path", "Path Management", "Clear path '{0}'", "Removes all points from the specified path.", "ClearPath");

AddStringParam("Path Name", "The name of the path whose index should be set.", "\"Default\"");
...
AddStringParam("Path Name", "The name of the path to insert the point into.", "\"Default\"");
...
AddStringParam("Path Name", "The name of the path collection to delete.", "\"Default\"");
AddAction(7, af_none, "Delete path", "Path Management", "Delete path collection '{0}'", "Removes the named path list entirely.", "DeletePath");

////////////////////////////////////////
// Expressions
AddStringParam("Path Name", "The name of the path list to query.", "\"Default\"");
...
////////////////////////////////////////
// Conditions
AddStringParam("Path Name", "The name of the path to check.", "\"Default\"");
