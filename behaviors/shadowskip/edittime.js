﻿function GetBehaviorSettings()
{
	return {
		...
		"id":			"ShadowSkip",			// this is used to identify this behavior and is saved to the project; never change it
...
AddCondition(0, cf_none, "Is enabled", "General", "{my} is enabled", "Check if the Shadow Skip behavior is currently enabled.", "IsEnabled");
...
AddAction(0, af_none, "Set enabled", "General", "Set {my} to {0}", "Enable or disable the Shadow Skip behavior.", "SetEnabled");
...
var property_list = [
	new cr.Property(ept_float, 		"Amplitude",		10,		"The maximum vertical bounce in pixels."),
	new cr.Property(ept_float, 		"Frequency",		5,		"How fast the bounce animation plays (higher = faster)."),
	new cr.Property(ept_float, 		"Squash Ratio",		0.1,	"How much the child object squashes/stretches (0.1 = 10% of size)."),
